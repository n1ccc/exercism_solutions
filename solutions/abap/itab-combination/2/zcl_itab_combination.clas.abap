...
CLASS zcl_itab_combination IMPLEMENTATION.
  ...
  METHOD perform_combination.
    ...
    LOOP AT combined_data REFERENCE INTO data(combined_line).
      numtab_line = nums[ sy-tabix ].
      combined_line->colx = |{ combined_line->colx }{ numtab_line-col1 }|.
      combined_line->coly = |{ combined_line->coly }{ numtab_line-col2 }|.
      combined_line->colz = |{ combined_line->colz }{ numtab_line-col3 }|.
    ENDLOOP.
  ENDMETHOD.
